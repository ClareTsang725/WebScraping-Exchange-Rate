...
for i in range(df.shape[0]):
    ...
    # create driver using chrome and open the path with it
    ...
    # collecting the information about currencies required and amount
    ...
    # select from_currency field and click the appropriate currency option
    field1 = driver.find_element(By.ID, "from")
    field1.click()
    driver.find_element(By.XPATH, "//div[@class='ac_results']/ul/li[.='" + from_currency + "']").click()

    # select to_currency field and click the appropriate currency option
